        ...
        <div className="flex space-x-4">
          ...
          <div className="flex-1">
            ...
            <input
              type="text"
              name="title"
              className="w-full bg-transparent border-none text-xl font-semibold placeholder-slate-400 focus:ring-0 focus:outline-none p-0 mb-2"
              placeholder="Title"
              disabled={isPending}
            />
            ...
            <textarea
              name="content"
              className="w-full bg-transparent border-none text-lg placeholder-slate-400 focus:ring-0 focus:outline-none resize-none h-20 p-0"
            ...
            <div className="flex items-center justify-between mt-3 pt-3 border-t border-slate-200">
              ...
              <button
                type="submit"
                disabled={isPending}
                className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-6 rounded-full shadow transition text-sm disabled:opacity-60 disabled:cursor-not-allowed"
              >
