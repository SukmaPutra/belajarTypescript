    ...
    <Card padding="md" hoverable={false} className="flex gap-3">
      ...
      <form onSubmit={submit} className="flex-1 flex flex-col gap-3">
        ...
        <textarea
          ...
          rows={3}
          className="w-full bg-transparent text-white placeholder:text-[#475569]
            text-sm resize-none focus:outline-none overflow-hidden"
        />
        ...
        {preview && (
          <div className="relative w-fit max-w-full">
            ...
            <button
              ...
              className="absolute top-1.5 right-1.5 bg-black/70 text-white
        ...
        <div className="flex items-center justify-between pt-2 border-t border-[#1e293b]">
          ...
          <div>
            ...
            <button
              ...
              className="text-[#475569] hover:text-sky-400 transition-colors p-1.5
                rounded-full hover:bg-sky-400/10"
            >
              <ImagePlus size={18} />
            </button>
          </div>
